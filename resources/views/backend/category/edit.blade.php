...
@section('title', 'Update Category Information')
@section('breadcrumb', 'Update Category Information '.$category->name)
    ...
    <div class="row">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="h3 mb-0">Update Category Information</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Category Information / {{$category->name}}</li>
                        </ol>
                    </div>
            ...
            <div class="card card-primary card-outline mb-4">
                <div class="card-body">
                    <div>
                        ...
                        <form id="categoryForm" class="content_form" action="{{ route('admin.category.update',$category->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <input type="text" name="site_title" value="{{$category->site_title}}" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                    <label for="meta_keyword" class="form-label">Meta Keyword <span class="text-danger"> Use
                                            Comma " , " *</span></label>
                                    <textarea name="meta_keyword" id="meta_keyword" cols="30" rows="3" class="form-control">{{ $category->meta_keyword }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class=" mb-3 col-6 form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                name="status" id="flexSwitchCheckChecked" {{ $category->status == 1 ? 'checked' : '' }} >
                                        ...
                                        <div class=" mb-3 col-6 form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                name="is_featured" id="flexSwitchCheckChecked" {{ $category->is_featured == 1 ? 'checked' : '' }}>
                            ...
                            <button type="submit" id="submit" class="btn btn-primary">Save & Back</button>
