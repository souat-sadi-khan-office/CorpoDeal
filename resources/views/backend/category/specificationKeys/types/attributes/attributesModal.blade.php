...
<div class="modal-header">
    <h5 class="modal-title">
        <strong>Specification Key Type Attributes</strong>
    </h5>
    ...
    <div class="row">
        <div class="col-md-12 table-responsive table-specification">
            <table class="table table-bordered table-striped table-hover" id="data-table">
                <thead>
                    <tr>
                        <th style="width: 77%;">Name &nbsp;&nbsp; & &nbsp;&nbsp; Extra <span class="text-danger">*</span></th>
                                    ...
                                    <form
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 form-group">
                                                ...
                                                <input type="hidden" name="status[]" class="form-control" value="{{ $data->status }}">
                                                <input type="hidden" name="id[]" class="form-control" value="{{ $data->id }}">
                                            </div>
                                            <div class="col-md-5 form-group">
                                                <input type="text" name="extra[]" id="extra{{ $data->id }}" class="form-control extra-input" value="{{ $data->extra }}">
                                            </div>
                                            <div class="col-md-2">
