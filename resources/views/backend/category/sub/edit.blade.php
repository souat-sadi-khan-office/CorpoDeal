    ...
    <div class="row">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="h3 mb-0">Update Category</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                Update Sub Category Information / {{ $category->name }}
                            </li>
                        </ol>
                    </div>
                    ...
                    <div>
                        ...
                        <form id="categoryForm" class="content_form"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    <label for="header" class="form-label">Header 
                                        <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-4 mt-4 p-5">
                                    <div class="row">
                                        <div class=" mb-3 col-6 form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" name="status" id="flexSwitchCheckChecked" {{ $category->status == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class=" mb-3 col-6 form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" name="is_featured" id="flexSwitchCheckChecked" {{ $category->is_featured == 1 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="flexSwitchCheckChecked">
                                                Featured?
                                                <span class="text-danger">*</span>
                                            </label>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <button type="submit" id="submit" class="btn btn-block btn-sm btn-outline-dark">
                                        Update Category Information
                                    </button>
                                    <button type="button" id="submitting" class="btn btn-block btn-sm btn-outline-dark" style="display: none;" disabled>
                                        Submitting...
                                    </button>
                                </div>
                            </div>
