                    ...
                    <div class="card-body">
                        <form id="product_search_form" action="{{ url()->current() }}" method="GET" class="row">
                            <div class="col-md-4 mb-3 form-group">
                                ...
                                <select name="payment_method" id="payment_method" class="form-control select" data-placeholder="Search by Payment Method" data-minimum-results-for-search="Infinity">
                            ...
                            <div class="col-md-4 mb-3 form-group">
                                ...
                                <select name="payment_status" id="payment_status" class="form-control select" data-minimum-results-for-search="Infinity" data-placeholder="Search by Payment Status">
                            ...
                            <div class="col-md-4 mb-3 form-group">
                                ...
                                <select name="between" id="between" class="form-control select" data-minimum-results-for-search="Infinity">
                            ...
                            <div class="col-md-4 mb-3 form-group">
                                ...
                                <select name="status" id="status" class="form-control select" data-minimum-results-for-search="Infinity" data-placeholder="Search by Order Status">
                            ...
                            <h5>Total Sold Amount {{ get_system_default_currency()->symbol . number_format(round(covert_to_defalut_currency($revenue),2), 2) }}</h5>
                    ...
                    @foreach($data as $report)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-2">
                                        <img src="{{ isset($report['image']) ? asset($report['image']) : asset('placeholder.png') }}" alt="Product Image {{ $loop->iteration }}" height="50px" width="auto">
                                    </div>
                            ...
                            <td>
                                ...
                                {{ $report['average_rating'] }}/5 ({{ $report['ratings_count'] }})</td>
                        </tr>
                    @endforeach
