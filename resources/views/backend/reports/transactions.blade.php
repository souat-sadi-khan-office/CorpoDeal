...
@section('page_name')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <h1 class="h3 mb-0">{{$type==='cod'?'Cash On Delivery': ucwords($type)}} Transactions Report - <span
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            {{$type==='cod'?'Cash On Delivery': ucwords($type)}} Transactions Report
            ...
            <div class="col-md-12 mb-3">
                <form id="product_search_form" action="{{ url()->current() }}" method="GET" class="row">
                    ...
                    <div class="col-md-4 mb-3 form-group">
                        <label for="between">Search by Order Date</label>
                    ...
                    <div class="col-md-8 mb-3 form-group">
                        <div class="row">
                            <div class="col-6 form-group">
                                <label for="date_range_from">From (Order):</label>
                                <input type="date" id="date_range_from" value="{{ request()->from }}" name="from"
                                       class="form-control">
                            </div>
                            <div class="col-6 form-group">
                                <label for="date_range_to">To (Order):</label>
