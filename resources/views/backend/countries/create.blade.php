<form action="{{ route("admin.country.store") }}" enctype="multipart/form-data" method="POST" class="ajax-form">
    <div class="modal-header">
        <h5 class="h6 mb-0">
            <strong>Add New Country for Shipping</strong>
        </h5>
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <select name="zone_id" id="zone_id" class="form-control select" data-placeholder="Select Zone" data-parsley-errors-container="#zone_error" required data-minimum-results-for-search="Infinity">
