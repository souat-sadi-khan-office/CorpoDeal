@extends('backend.layouts.app', ['title' => 'Create new tier'])
@section('page_name')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" name="discount_amount" id="discount_amount" class="form-control number" required value="0">
                            </div>
                            
                            <div class="col-md-6 form-group mb-3">
                                <label for="threshold">Threshold Amount <span class="text-danger">*</span></label>
                                <input type="text" name="threshold" id="threshold" class="form-control number" required value="0">
                            </div>

                            <div class="col-md-6 form-group mb-3">
                                <label for="usage_limit">Maximum Number Of Usage <span class="text-danger">*</span></label>
                                <input type="text" name="usage_limit" id="usage_limit" class="form-control number" required value="100">
                            </div>
