                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <textarea name="short_content" id="short_content" cols="30" rows="3" class="form-control">{{ $model->short_content }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12 mb-3 form-group">
                                ...
                                <small class="text-danger">Image Size will be 500 X 500 pixel</small>
                            </div>
