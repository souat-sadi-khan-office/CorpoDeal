...
@section('title', 'Shipping City Management')
@push('style')
            ...
            <div class="row">
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Shipping City Management</li>
                    </ol>
                </div>

                {{-- @if (Auth::guard('admin')->user()->hasPermissionTo('city.create')) --}}
                    <div class="col-sm-6 text-end">
                        <a href="javascript:;" data-url="{{ route('admin.city.create') }}" id="content_management" class="btn btn-sm btn-outline-dark">
