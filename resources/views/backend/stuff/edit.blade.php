                ...
                @if (Auth::guard('admin')->user()->hasPermissionTo('stuff.view'))
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('admin.stuff.index') }}" class="btn btn-sm btn-outline-danger">
                            <i class="bi bi-backspace" style="margin-right: 10px;"></i>
                            Back
                        </a>
                    </div>
                @endif
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.stuff.update', $model->id) }}" class="content_form" method="post">
                @csrf
                @method('PATCH')
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                {{-- @if (Auth::guard('admin')->user()->hasPermissionTo('stuff.update')) --}}
                                    ...
                                    <button class="btn btn-outline-dark" style="display: none;" id="submitting" type="button" disabled>
