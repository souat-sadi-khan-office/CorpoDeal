            ...
            <div class="row">
                <div class="col-sm-8">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Customer Reviews Management</li>
                    </ol>
                </div>
                @if (Auth::guard('admin')->user()->hasPermissionTo('customer-review.create'))
                    <div class="col-sm-4 text-end">
                        <a href="{{ route('admin.customer-review.create') }}" class="btn btn-soft-success">
                ...
                <div class="col-md-12 mb-3">
                    <div class="row">
                        <div class="col-md-10 mb-3 form-group">
                            <label for="product_id">Search Reviews by Products</label>
        ...
        $(function () {
            ...
            if(selected_product_id != '') {
                ...
                var table = $('#data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.customer-review.index', ['product_id' => $product_id]) }}",
                    columns: [
                        {data: 'date', name: 'date'},
                        {data: 'name', name: 'name'},
            ...
            $(document).on('click', '#search_button', function() {
                ...
                window.location.href= "/admin/customer-review" + url;
            });

            // reset button click
            $(document).on('click', '#reset_button', function() {
                let url = '/admin/customer-review';
