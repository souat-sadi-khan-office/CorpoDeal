        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header">
                    <h1 class="h6 mb-0">
                        <b>Website Header Configuration</b>
                    </h1>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="align-items-start">
                                <div class="row">
                                    {{-- <div class="col-md-6 mb-3 form-group">
                                        ...
                                        <select name="system_show_language_switcher" id="system_show_language_switcher" class="form-control">
                                    ...
                                    {{-- <div class="col-md-6 mb-3 form-group">
                                        ...
                                        <select name="system_show_currency_switcher" id="system_show_currency_switcher" class="form-control">
                                    ...
                                    {{-- <div class="col-md-6 mb-3 form-group">
                                        ...
                                        <select name="system_sticky_header" id="system_sticky_header" class="form-control">
                                    ...
                                    <div class="col-md-6 mb-3 form-group">
                                        ...
                                        <select name="system_show_top_bar_banner" id="system_show_top_bar_banner" class="form-control">
                ...
                <div class="card-footer">
                    ...
                    <button type="button" class="btn btn-outline-dark btn-sm add-more">
