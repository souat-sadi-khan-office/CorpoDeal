<form action="{{ route("admin.customer.address.update", $model->id) }}" method="POST" class="ajax-form">
    ...
    <div class="modal-header">
        <h5 class="h6 mb-0">
            <b>Update Address Information</b>
        </h5>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="country_id" id="country_id" class="form-control select" data-parsley-errors-container="#country_id_error" required data-placeholder="Select Country" data-minimum-results-for-search="Infinity">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="city_id" id="city_id" class="form-control select" data-parsley-errors-container="#city_id_error" required data-placeholder="Select City" data-minimum-results-for-search="Infinity">
