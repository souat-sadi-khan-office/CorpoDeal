@extends('frontend.layouts.app', ['title' => get_settings('reset_password_site_title')])
@section('meta')
<meta property="og:image:width" content="200">
    ...
    <meta property="og:title" content="{{ get_settings('reset_password_meta_title') }}">	
    <meta property="og:description" content="{{ get_settings('reset_password_meta_description') }}.">	
    ...
    <meta name="twitter:title" content="{{ get_settings('reset_password_meta_title') }}" />
    <meta name="twitter:description" content="{{ get_settings('reset_password_meta_description') }}" />	
                    ...
                    <div class="col-xl-6 col-md-10">
                        <div class="login_wrap">
                            <div class="padding_eight_all bg-white">
                                ...
                                <form method="POST" id="reset-password-form" action="{{ route('post.reset.password') }}">
                                    @csrf
                                    <div class="row">
...
@endsection
@push('scripts')
    <script src="{{ asset('frontend/assets/js/pages/reset_password.js') }}"></script>
@endpush