            ...
            <div class="row align-items-center">
                ...
                <div class="col-3">
                    <div class="input-group input-spinner">
                        <button type="button" class="minus button-minus btn btn-sm minus-{{ $model['id'] }}" data-slug="{{ $model['slug'] }}" data-id="{{ $model['id'] }}" style="{{ $model['quantity'] > 1 ? '' : 'display:none;' }}">-</button>
                        
                        <input disabled type="text" readonly step="1" max="10" value="{{ $model['quantity'] }} " name="quantity" class="quantity-field number form-control-sm form-input qty" size="4" id="qty_{{ $model['id'] }}">

                        <button type="button" class="plus button-plus btn btn-sm plus-{{ $model['id'] }}" data-slug="{{ $model['slug'] }}" data-id="{{ $model['id'] }}">+</button>
                    </div>
                </div>
